...
"""
    ...
    print("%s\033[1;91m [%s1%s]%s\033[1;91m CRACK RANDOM FB ID 2012-15 %s(FREE)" % (R, G, R, Y, G))
    print("%s\033[1;92m [%s2%s]%s\033[1;92m CRACK RANDOM FB ID 2011-13 %s(FREE)" % (R, G, R, Y, G))
    print("%s\033[1;93m [%s3%s]%s\033[1;93m CRACK RANDOM FB ID 2008-11 %s(FREE)" % (R, G, R, Y, G))
    print("%s\033[1;94m [%s4%s]%s\033[1;94m CRACK RANDOM FB ID 2009    %s(FREE)" % (R, G, R, Y, G))
    print("%s\033[1;95m [%s5%s]%s\033[1;95m CRACK RANDOM FB ID 2005-7 %s(FREE)" % (R, G, R, Y, G))
    print("%s\033[1;96m [%s6%s]%s\033[1;96m CRACK RANDOM FB ID 2004-6 %s(FREE)" % (R, G, R, Y, G))
    print("%s\033[1;97m [%s7%s]%s\033[1;97m CRACK RANDOM FB ID 2004-5 %s(FREE)" % (R, G, R, Y, G))
    print("%s\033[1;95m [%s8%s]%s\033[1;95m CRACK RANDOM FB ID 2003-4 %s(FERR)" % (R, G, R, Y, G))
    print("%s\033[1;94m [%s9%s]%s\033[1;94m CRACK FROM EMAILS %s(FREE)" % (R, G, R, Y, G))
    print(GET)
    hoga = input("\n%s [?] CHOICE : " % (B))
    if hoga in ["", " "]:
        Main()
...
def api(self, uid, pwx):
    ...
    sys.stdout.write(
        "\r\r %s[>_] [PLAY] : %s/%s -> \033[0;92m [ PLAY-OK:%s ]- \033[0;91m[PLAY-CP:%s ]" % (
